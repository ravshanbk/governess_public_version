...
class NurseEditDailyChildrenPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Widget> inputFields = List.generate(
      ...
      (__) {
        return TextFormField(
          ...
          autofocus: false,
          focusNode: context
              .watch<NurseEditingChildrenNumberPageProvider>()
              .nodes![__],
          keyboardType: TextInputType.number,
          cursorColor: mainColor,
          onFieldSubmitted: (v) {
            if (__ <
                Provider.of<NurseEditingChildrenNumberPageProvider>(context,
                            listen: false)
                        .nodes!
                        .length -
                    1) {
    ...
    return Scaffold(
      ...
      body: Form(
        key: context.read<NurseEditingChildrenNumberPageProvider>().formKey,
        child: Column(
          children: [
            ListView.separated(
  ...
  AddButtonWidget _addButton(BuildContext context) {
    return AddButtonWidget(
      callBack: () async {
        if (Provider.of<NurseEditingChildrenNumberPageProvider>(context,
                listen: false)
            .formKey
            .currentState!
            .validate()) {
