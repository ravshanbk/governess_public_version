    ...
    return ListView.separated(
                ...
                itemBuilder: (_, __) {
                  return ShowInOutListProductWidget(
                    ...
                    data: data[__],
                    isExpanded: context
                            .watch<ShowInOutListProductProvider>()
                            .current ==
                        __,
                      ...
                      (index) => Column(
                        children: [
                          ...
                          TextInRowWidget("O'lchov birligi",
                              data[__].inOutList!.length.toString()),
                          _divider(),
                          TextInRowWidget(
                              "EnterDate",
                              DTFM.maker(
                                  data[__].inOutList![index].enterDate!)),
                          _divider(),
                          TextInRowWidget("Mahsulot Id",
                          ...
                          _divider(),
                          TextInRowWidget("Narxi",
                              data[__].inOutList![index].price.toString()),
                          _divider(),
                          TextInRowWidget(
                              "Umumiy miqdor",
                              data[__]
